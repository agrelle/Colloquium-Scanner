...
class main(wx.Frame):
    def __init__(self, title):
        ...
        try:
            icon = wx.Icon("." + os.sep + 'Images' + os.sep + 'icon.ico', wx.BITMAP_TYPE_ICO,16,16)
            self.SetIcon(icon)
        except: pass
        self.parent = self
        self.status = False
        ...
        try:
            image1 = wx.Image("." + os.sep + "Images" + os.sep + "Main_Frame.jpg", wx.BITMAP_TYPE_ANY).ConvertToBitmap()
